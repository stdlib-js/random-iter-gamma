...
tape( 'the function throws an error if shape parameter `alpha` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if rate parameter `beta` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator for generating pseudorandom numbers from a gamma distribution', function test( t ) {
	var rand;
	var it;
	var i;
