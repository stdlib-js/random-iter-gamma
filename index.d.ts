...
/**
* Interface for iterators of pseudorandom numbers drawn from a gamma distribution.
*/
...
* // ...
*/
declare function iterator( alpha: number, beta: number, options?: Options ): RandIter; // tslint:disable-line:max-line-length
